...
class ProductController extends Controller
{
    ...
    public function config(){
        ...
        $products = DB::table('config')->get();

        return view('admin.products.config', ['products' => $products]);
    }
    ...
    public function storeConfig(Request $request){
        ...
        return redirect('/config')->with('message', 'Guardado con Éxito.')->with('typealert', 'success');
    }
